...
typedef void(__cdecl* _ADD_BLIP_FOR_COORD)(float x, float y, float z, int* pBlip);
typedef int(__cdecl* _ADD_SPHERE)(float x, float y, float z, float r, int unk);
...
typedef void(__cdecl* _CREATE_OBJECT)(int modelHash, float x, float y, float z, int* pObject, int bAlways1);
typedef void(__cdecl* _CREATE_OBJECT_CALL)(void* pObject);
typedef void(__cdecl* _DELETE_OBJECT)(void* object);
...
typedef void(__cdecl* _FREEZE_OBJECT_POSITION)(int pHandle, bool frozen);
...
typedef void(__cdecl* _REMOVE_SPHERE)(int sphereId, char unk);
...
static _CREATE_OBJECT CREATE_OBJECT;
static _CREATE_OBJECT_CALL CREATE_OBJECT_CALL;
static _DELETE_OBJECT DELETE_OBJECT;
...
static _FREEZE_OBJECT_POSITION FREEZE_OBJECT_POSITION;
...
static _PRINT PRINT;
static _REMOVE_SPHERE REMOVE_SPHERE;
...
void registerFunctions(uintptr_t moduleBase) {
  ...
  ADD_SPHERE = (_ADD_SPHERE)(moduleBase + 0x5BFBD0);
  CHANGE_CAR_COLOUR = (_CHANGE_CAR_COLOUR)(moduleBase + 0x5DEDF0);
  CLEAR_WANTED_LEVEL = (_CLEAR_WANTED_LEVEL)(moduleBase + 0x5F6F60);
  CREATE_OBJECT = (_CREATE_OBJECT)(moduleBase + 0x5DAE60);
  CREATE_OBJECT_CALL = (_CREATE_OBJECT_CALL)(moduleBase + 0x5DBD20);
  DELETE_OBJECT = (_DELETE_OBJECT)(moduleBase + 0x5DBE00);
  ...
  FREEZE_OBJECT_POSITION = (_FREEZE_OBJECT_POSITION)(moduleBase + 0x5D6DA0);
  ...
  REMOVE_SPHERE = (_REMOVE_SPHERE)(moduleBase + 0x3FE640);
